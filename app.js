...
function clickHandler(e){
  ...
  if(dateStr!=""){
    var withoutHypen=dateStr.split("-");
    var date={
      day:Number(withoutHypen[2]),
      month:Number(withoutHypen[1]),
      year:Number(withoutHypen[0]),
    }

    var isThisPalindrome=checkPalindromeForAllDateFormats(date);
